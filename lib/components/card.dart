          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text(nome, style: const TextStyle(color: AppColors.cinzaEsc, fontSize: 16)),
              ],
            ),
            const SizedBox(height: 4),
            // Data
            Row(
              children: [
                ...
                const SizedBox(width: 8),
                Text(tempSem, style: const TextStyle(color: AppColors.cinzaEsc, fontSize: 16)),
              ],
            ),
            const SizedBox(height: 10),
            Row(
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 8),
          Text(text, style: const TextStyle(color: AppColors.black, fontSize: 16)),
        ],
      ),
    );
  }
