    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                CustomTextButtom2(text: 'Os mais procurados', text2: 'Ver tudo', onPressed: (){
          ...
          const CustomBanner2(imagePath: 'assets/images/fundo2.jpg', text: 'Conecte-se e fortaleça sua comunidade com o voluntariado. Encontre oportunidades próximas ou pessoas dispostas a ajudar sua causa. Cadastre sua organização, crie vagas e coordene projetos com facilidade.')
        ],
      ),
    );
  }
